  ...
  return (
    <nav
      className={cn(
        ...
        "bg-[#f3f6f1]/95 dark:bg-[#171c1a]/95",
        "backdrop-blur-xl",
        "px-1.5 pt-2",
        "pb-[calc(8px+env(safe-area-inset-bottom))]",
        "shadow-[0_-6px_22px_rgba(0,0,0,.09)]",
        "dark:border-white/[.055] dark:shadow-[0_-6px_22px_rgba(0,0,0,.35)]"
      )}
    >
          ...
          return (
            <HapticLink
              ...
              className={cn(
                ...
                active
                  ? "bg-mint-50 text-mint-700 dark:bg-mint-900/25 dark:text-mint-300"
            ...
            >
              ...
              />
              <span className="mt-0.5 w-full truncate text-center px-1">
                {label}
              </span>
            </HapticLink>
          );
